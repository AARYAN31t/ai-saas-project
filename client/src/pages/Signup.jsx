...
import { Mail, Lock, UserPlus, Sparkles, Loader2, User } from 'lucide-react';
...
const Signup = ({ setUser }) => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#050505] p-6 relative overflow-hidden">
            {/* Ambient Background */}
            <div className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] bg-purple-600/5 rounded-full blur-[120px] pointer-events-none" />
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-5xl font-black mb-3 tracking-tighter">Join Promptify</h1>
                    <p className="text-slate-500 font-bold uppercase tracking-[0.2em] text-xs">Start your AI journey today</p>
                </div>
                ...
                <div className="glass p-12 rounded-[45px] border border-white/5 relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2.5">
                            ...
                            <div className="relative group">
                                <User className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-500 group-hover:text-primary transition-colors" size={20} />
                                <input
                                    type="text"
                                    value={name}
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full btn-primary h-18 mt-4 text-lg font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3"
                        >
                            {isLoading ? <Loader2 className="animate-spin" /> : <UserPlus size={22} />}
                    ...
                    <div className="mt-10 pt-8 border-t border-white/5 text-center">
                        <p className="text-slate-500 font-bold text-sm">
                            ...
                            <Link to="/login" className="text-primary hover:text-indigo-400 transition-colors underline underline-offset-4">
                                Sign In
                            </Link>
                        </p>
                    </div>
